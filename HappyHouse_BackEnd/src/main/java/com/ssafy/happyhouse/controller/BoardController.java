...
public class BoardController {
	...
	@PostMapping
	public ResponseEntity<String> registerArticle(@RequestBody @ApiParam(value = "게시글 정보.", required = true) BoardDto boardDto) throws Exception {
		logger.info("registerArticle - 호출");
		if (boardService.registerArticle(boardDto)) {
...
//	@PostMapping("/reply")
//	public ResponseEntity<String> replyArticle(@RequestBody @ApiParam(value = "게시글 답글 정보.", required = true) BoardDto boardDto) throws Exception {
//		logger.info("replyArticle - 호출");
//		if (boardService.replyArticle(boardDto)) {
//			return new ResponseEntity<String>(SUCCESS, HttpStatus.OK);
//		}
//		return new ResponseEntity<String>(FAIL, HttpStatus.NO_CONTENT);
//	}
	...
	@PutMapping
	public ResponseEntity<String> updateArticle(@RequestBody @ApiParam(value = "수정할 글정보.", required = true) BoardDto boardDto) throws Exception {
